...
🚀 Featured Project: QuickBite Crisis Recovery Analysis

A data-driven turnaround strategy for QuickBite Express, a food-tech startup that faced a major customer trust crisis in 2025.
As the data analyst (Peter Pandey), I analyzed the complete dataset and built a recovery framework with:
